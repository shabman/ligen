...
#define PRINT( msg, col )         \
  std::cout << col << msg << "\n" \
            << termcolor::reset;

#define PRINT_LOG( log, msg )                                                                               \
  if ( std::string ( log ) == "warn" )                                                                      \
    {                                                                                                       \
      std::cout << "[" << termcolor::yellow << "LIGEN WARNING" << termcolor::reset << "]: " << msg << "\n"; \
    }                                                                                                       \
  if ( std::string ( log ) == "error" )                                                                     \
    {                                                                                                       \
      std::cout << "[" << termcolor::red << "LIGEN ERROR" << termcolor::reset << "]: " << msg << "\n";      \
    }                                                                                                       \
  if ( std::string ( log ) == "log" )                                                                       \
    {                                                                                                       \
      std::cout << "[" << termcolor::green << "LIGEN" << termcolor::reset << "]: " << msg << "\n";          \
    }
